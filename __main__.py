...
def print_slow(text: str, trailing_newline=True, delay=0.035):
...
check(width >= min_width, 'window width',
      f'Please make sure your terminal window has at least {min_width} columns.')
check(height >= min_height, 'window height',
      f'Please make sure your terminal window has at least {min_height} rows.')
